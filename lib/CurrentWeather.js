      ...
      <div className="container">
        ...
        <div className="mainContent">
          ...
          <div className="tempRange">
            <p className="high">Today's High: {todayHigh}<span className="degrees">&#8457;</span></p>
            <p className="low">Today's Low: {todayLow}<span className="degrees">&#8457;</span></p>
          </div>
        </div>
        <p className="dailyReport">Today's Forecast: {dailyReport}</p>
      </div>
    );
  }
}
