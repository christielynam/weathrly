...
export default class Search extends React.Component {
  ...
  getLocation(userInput) {
    ...
    console.log('after join:', splitInput);
  ...
  render() {
    return (
      <div className="search-container">
        <input onKeyDown={this.handleEnter.bind(this)} onChange={this.handleChange.bind(this)} className="searchInput" placeholder="Find weather by zip code or city, state" />
      </div>
    );
  }
